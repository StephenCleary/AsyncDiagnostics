    ...
    public class AsyncDiagnosticAspect : MethodLevelAspect, IAspectProvider
    {
        ...
        public IEnumerable<AspectInstance> ProvideAspects(object targetElement)
        {
            ...
            if (stateMachineAttribute == null)
            {
                ...
                yield return new AspectInstance(targetElement, new SynchronousTracingAspect(methodName));
            }
            else
            {
                ...
                yield return new AspectInstance(moveNextMethod, new AsynchronousTracingAspect(stateField, "async " + methodName));
            }
        }
        ...
        public class SynchronousTracingAspect : OnMethodBoundaryAspect
        {
            ...
            public SynchronousTracingAspect(string methodName)
            {
        ...
        public class AsynchronousTracingAspect : MethodInterceptionAspect
        {
            ...
            public AsynchronousTracingAspect(FieldInfo state, string methodName)
            {
